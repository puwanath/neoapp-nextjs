  ...
  $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
    ...
    return this.each(function() {
      ...
      if (!this.grid) {
        ...
        var z, A = ["shiftKey", "altKey", "ctrlKey"],
          ...
          L = function() {
            ...
            if ("local" === m.datatype && !0 === p.repeatitems)
              for (j = J(s), k = I("local"), d = !1 === m.keyName ? $.isFunction(p.id) ? p.id.call(e, n) : p.id : m.keyName, a = 0; a < o; a++) {
          ...
          T = function(a, b) {
            var c, d, f, g, h, i, j, k, l = "",
              p = e.p.pager ? $.jgrid.jqID(e.p.pager.substr(1)) : "",
              r = p ? "_" + p : "",
            ...
            if (l = e.p.pager || "", l += e.p.toppager ? l ? "," + e.p.toppager : e.p.toppager : "") {
              if (j = $.jgrid.getRegional(e, "formatter.integer"), c = B(e.p.page), d = B(e.p.lastpage), $(".selbox", l)[this.p.useProp ? "prop" : "attr"]("disabled", !1), !0 === e.p.pginput && ($("#input" + r).html($.jgrid.template($.jgrid.getRegional(e, "defaults.pgtext", e.p.pgtext) || "", "<input " + m(n, "pgInput", !1, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(p) + "'></span>")), e.p.toppager && $("#input_t" + s).html($.jgrid.template($.jgrid.getRegional(e, "defaults.pgtext", e.p.pgtext) || "", "<input " + m(n, "pgInput", !1, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(p) + "_toppager'></span>")), $(".ui-pg-input", l).val(e.p.page), k = e.p.toppager ? "#sp_1" + r + ",#sp_1" + r + "_toppager" : "#sp_1" + r, $(k).html($.fmatter ? $.fmatter.util.NumberFormat(e.p.lastpage, j) : e.p.lastpage)), e.p.viewrecords)
                if (0 === e.p.reccount) $(".ui-paging-info", l).html($.jgrid.getRegional(e, "defaults.emptyrecords", e.p.emptyrecords));
                else {
          ...
          _ = function(a, b) {
            var c, d, f, g, h, j, k, l = "<td class='ui-pg-button " + o + "'><span class='ui-separator'></span></td>",
              p = "",
              r = "<table class='ui-pg-table ui-common-table ui-paging-pager'><tbody><tr>",
              t = "",
              u = function(a, b) {
                var c;
          ...
          ba = function(a, b, c, d, f) {
            if (e.p.colModel[b].sortable && !(e.p.savedRow.length > 0)) {
              if (c || (e.p.lastsort === b && "" !== e.p.sortname ? "asc" === e.p.sortorder ? e.p.sortorder = "desc" : "desc" === e.p.sortorder && (e.p.sortorder = "asc") : e.p.sortorder = e.p.colModel[b].firstsortorder || "asc", e.p.page = 1), e.p.multiSort) aa(b, f, d);
              else {
                if (d) {
          ...
          ca = function() {
            var a, b, c, d, g = 0,
              h = $.jgrid.cell_width ? 0 : B(e.p.cellLayout, 0),
              i = 0,
              j = B(e.p.scrollOffset, 0),
              k = !1,
              l = 0;
        ...
        var ma, na, oa, pa, qa, ra, sa, ta, ua, va = "<thead><tr class='ui-jqgrid-labels' role='row'>",
          wa = "",
          xa = "",
          ya = "";
        ...
        var Da = "",
          Ea = -1 === e.p.styleUI.search("Bootstrap") || isNaN(e.p.height) ? 0 : 2;
        ...
        var Fa = $("tr:first", va),
          Ga = "<tr class='jqgfirstrow' role='row'>";
        ...
        va = null, f.hDiv = document.createElement("div"), f.hDiv.style.width = f.width - Ea + "px", f.hDiv.className = m(n, "headerDiv", !0, "ui-jqgrid-hdiv"), $(f.hDiv).append(Ja), $(Ja).append(Ha), Ha = null, Ia && $(f.hDiv).hide(), e.p.pager && ("string" == typeof e.p.pager ? "#" !== e.p.pager.substr(0, 1) && (e.p.pager = "#" + e.p.pager) : e.p.pager = "#" + $(e.p.pager).attr("id"), $(e.p.pager).css({
          width: f.width - Ea + "px"
        }).addClass(m(n, "pagerBox", !0, "ui-jqgrid-pager")).appendTo(y), Ia && $(e.p.pager).hide(), _(e.p.pager, "")), !1 === e.p.cellEdit && !0 === e.p.hoverrows && $(e).on({
        ...
        $(e).before(f.hDiv).on({
          click: function(a) {
            ...
            if ("A" !== qa.tagName && ("INPUT" !== qa.tagName && "TEXTAREA" !== qa.tagName && "OPTION" !== qa.tagName && "SELECT" !== qa.tagName || c))
              if (Ka = ra[0].id, qa = $(qa).closest("tr.jqgrow>td"), qa.length > 0 && (La = $.jgrid.getCellIndex(qa)), !0 !== e.p.cellEdit) {
                if (qa.length > 0 && (Ma = $(qa).closest("td,th").html(), $(e).triggerHandler("jqGridCellSelect", [Ka, La, Ma, a]), $.isFunction(e.p.onCellSelect) && e.p.onCellSelect.call(e, Ka, La, Ma, a)), d)
                  if (e.p.multimail && e.p.multiselect) {
                    if (a.shiftKey) {
                      if (c) {
                        var g = $(e).jqGrid("getGridParam", "selrow"),
                          h = $(e).jqGrid("getInd", Ka),
                          i = $(e).jqGrid("getInd", g),
                          j = "",
                          k = "";
              ...
              } else if (e.p.multiselect && c && d) $(e).jqGrid("setSelection", Ka, !0, a);
            else if (qa.length > 0) try {
        ...
        var Na = s + " " + m(n, "icon_caption_open", !0),
          Oa = s + " " + m(n, "icon_caption_close", !0);
        ...
        if ($(f.hDiv).after(f.bDiv).mousemove(function(a) {
          ...
          var Ta = "onorientationchange" in window,
    ...
    editCell: function(a, b, c, d) {
      return this.each(function() {
        var e, f, g, h, i = this,
          j = $(this).jqGrid("getStyleUI", i.p.styleUI + ".common", "highlight", !0),
        ...
        if (i.grid && !0 === i.p.cellEdit) {
          ...
          if (h = i.p.colModel[b], "subgrid" !== (e = h.name) && "cb" !== e && "rn" !== e) {
            ...
            if (g.addClass("edit-cell " + j), $(i.rows[a]).addClass("selected-row " + k), !0 !== h.editable || !0 !== c || g.hasClass("not-editable-cell") || $.isFunction(i.p.isCellEditable) && !i.p.isCellEditable.call(i, e, a, b)) f = g.html().replace(/\&#160\;/gi, ""), $(i).triggerHandler("jqGridCellSelect", [i.rows[a].id, b, f, d]), $.isFunction(i.p.onCellSelect) && i.p.onCellSelect.call(i, i.rows[a].id, b, f, d);
            else {
              try {
                f = $.unformat.call(i, g, {
                  rowId: i.rows[a].id,
    ...
    viewModal: function(a, b) {
      ...
      if (void 0 === b.focusField && (b.focusField = 0), "number" == typeof b.focusField && b.focusField >= 0 ? b.focusField = parseInt(b.focusField, 10) : "boolean" != typeof b.focusField || b.focusField ? b.focusField = 0 : b.focusField = !1, $.fn.jqm && !0 === b.jqm) b.jqM ? $(a).attr("aria-hidden", "false").jqm(b).jqmShow() : $(a).attr("aria-hidden", "false").jqmShow();
      else {
        if ("" !== b.gbox) {
      ...
      switch (a) {
        case "textarea":
          g = document.createElement("textarea"), d ? b.cols || $(g).css({
            width: "98%"
          }) : b.cols || (b.cols = 20), b.rows || (b.rows = 2), ("&nbsp;" === c || "&#160;" === c || 1 === c.length && 160 === c.charCodeAt(0)) && (c = ""), g.value = c, $(g).attr({
            role: "textbox",
            multiline: "true"
          }), f(g, b);
          break;
        ...
        default:
          var A;
          A = "button" === a ? "button" : "textbox", g = document.createElement("input"), g.type = a, g.value = c, "button" !== a && (d ? b.size || $(g).css({
            width: "96%"
          }) : b.size || (b.size = 20)), $(g).attr("role", A), f(g, b)
      }
      return g
    },
    ...
    validateForm: function(a) {
      ...
      for (b = 0; b < a.elements.length; b++)
        if (c = a.elements[b], ("INPUT" === c.nodeName || "TEXTAREA" === c.nodeName || "SELECT" === c.nodeName) && (void 0 !== c.willValidate ? ("INPUT" === c.nodeName && c.type !== c.getAttribute("type") && c.setCustomValidity($.jgrid.LegacyValidation(c) ? "" : "error"), c.reportValidity()) : (c.validity = c.validity || {}, c.validity.valid = $.jgrid.LegacyValidation(c)), !c.validity.valid)) {
          d = !1;
          break
        }
      return d
      ...
      if (!this.filter) {
        ...
        if (this.p.initFilter = $.extend(!0, {}, this.p.filter), c) {
          ...
          this.onchange = function() {
            ...
            o.append(q);
            var r, s = $("<select size='1' class='" + h.srSelect + "'></select>"),
              t = [];
    ...
    filterRefactor: function(a) {
      var b, c, d, e, f, g = {};
      try {
        if (g = "string" == typeof a.ruleGroup ? $.jgrid.parse(a.ruleGroup) : a.ruleGroup, g.rules && g.rules.length)
          ...
          var d, e, f, g = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].filter,
            ...
            j = function() {
              ...
              if ($.each(c.p.colModel, function() {
                  ...
                  if ("bt" === e && (l = !0), b || "nu" === e || "nn" === e) g[d] = b, i[d] = e, h++;
                  else try {
                ...
                if (!0 === a.stringResult || "local" === c.p.datatype || !0 === a.searchOperators) {
                  ...
                  if (j && (r = $.jgrid.filterRefactor({
                    ...
                    }), p = JSON.stringify(r)), l && ($.isPlainObject(r) || (r = $.jgrid.parse(p)), r.rules && r.rules.length))
                    for (s = r.rules, t = 0; t < s.length; t++) v = s[t], "bt" === v.op && (w = v.data.split("..."), w.length > 1 && (void 0 === r.groups && (r.groups = []), x = {
                      groupOp: "AND",
                      groups: [],
                      rules: []
                  ...
                  (l || j) && (p = JSON.stringify(r)), $.extend(c.p.postData, {
                    filters: p
                ...
                var y;
                a.url && (y = c.p.url, $(c).jqGrid("setGridParam", {
                  url: a.url
                }));
                var z = "stop" === $(c).triggerHandler("jqGridToolbarBeforeSearch");
                !z && $.isFunction(a.beforeSearch) && (z = a.beforeSearch.call(c)), z || $(c).jqGrid("setGridParam", {
                  search: o
                }).trigger("reloadGrid", [{
                  page: 1
              ...
              } else if ($.isFunction(n)) n.call(c, m[1]);
              else {
    ...
    refreshFilterToolbar: function(a) {
      return a = $.extend(!0, {
        ...
        function b(f) {
          if (f && f.rules) {
            for (g = f.rules, l = g.length, c = 0; c < l; c++)
              if (h = g[c], -1 !== (i = $.inArray(h.field, m)) && (e = $("#gs_" + j.p.idPrefix + $.jgrid.jqID(k[i].name)), e.length > 0 && ("select" === k[i].stype ? e.find("option[value='" + $.jgrid.jqID(h.data) + "']").prop("selected", !0) : "text" === k[i].stype && e.val(h.data), $.isFunction(a.onSetVal) && a.onSetVal.call(j, e, k[i].name), d && d.searchOperators))) {
                var n = e.parent().prev();
                n.hasClass("ui-search-oper") && ($(".soptclass", n).attr("soper", h.op), d.operands.hasOwnProperty(h.op) && $(".soptclass", n).html(d.operands[h.op]))
              }
            if (f.groups)
              for (var o = 0; o < f.groups.length; o++) b(f.groups[o])
          }
        }
          ...
          if (q.grid && a) {
            ...
            if (D ? (G = o(rp_ge[$(this)[0].p.id].template), r = y) : (G = $("<table id='" + x + "' class='EditTable ui-common-table'><tbody></tbody></table>"), r = y + "_2"), w = "#" + $.jgrid.jqID(w), $(J).append("<div class='FormError " + f.error + "' style='display:none;'></div>"), $(J).append("<div class='tinfo topinfo'>" + rp_ge[q.p.id].topinfo + "</div>"), $(q.p.colModel).each(function() {
              ...
              if ($.jgrid.createModal(z, V, rp_ge[$(this)[0].p.id], "#gview_" + $.jgrid.jqID(q.p.id), $("#gbox_" + $.jgrid.jqID(q.p.id))[0], null, {
                  "font-size": W
                }), K && ($("#pData, #nData", y + "_2").css("float", "right"), $(".EditButton", y + "_2").css("text-align", "left")), rp_ge[q.p.id].topinfo && $(".tinfo", w).show(), rp_ge[q.p.id].bottominfo && $(".binfo", w).show(), V = null, S = null, $("#" + $.jgrid.jqID(z.themodal)).keydown(function(a) {
                  var c = a.target;
          ...
          if (j.grid && a) {
            ...
            if ($(j.p.colModel).each(function() {
              ...
              $.jgrid.createModal(p, F, rp_ge[$(this)[0].p.id], "#gview_" + $.jgrid.jqID(j.p.id), $("#gview_" + $.jgrid.jqID(j.p.id))[0], null, {
                "font-size": G
              }), x && ($("#pData, #nData", "#" + m + "_2").css("float", "right"), $(".EditButton", "#" + m + "_2").css("text-align", "left")), b.viewPagerButtons || $("#pData, #nData", "#" + m + "_2").hide(), F = null, $("#" + p.themodal).keydown(function(a) {
        ...
        return b = $.extend(!0, {
          ...
          if (c.grid && a) {
            ...
            if (rp_ge[c.p.id].styleUI = c.p.styleUI || "jQueryUI", $.isArray(a) && (a = a.join()), void 0 !== $("#" + $.jgrid.jqID(o.themodal))[0]) {
              ...
              if (r += "<table class='EditTable ui-common-table' id='" + m + "_2'><tbody><tr><td><hr class='" + f.content + "' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>" + u + "</td></tr></tbody></table>", b.gbox = "#gbox_" + $.jgrid.jqID(j), $.jgrid.createModal(o, r, rp_ge[c.p.id], "#gview_" + $.jgrid.jqID(c.p.id), $("#gview_" + $.jgrid.jqID(c.p.id))[0], null, {
                  "font-size": v
          ...
          if (!this.p.navGrid) {
            ...
            if (o.grid && "string" == typeof a) {
              ...
              for (m.cloneToTop && o.p.toppager && (r = 2), q = 0; q < r; q++) {
                var u, v, w, x = $("<table class='ui-pg-table navtable ui-common-table'><tbody><tr></tr></tbody></table>"),
            ...
            l = function(a, b) {
              ...
              $(g).append(h), a && (f = c.p.xmlReader.subgrid, $(f.root + " " + f.row, a).each(function() {
                if (h = $("<tr class='" + j.content + " ui-subtblcell'></tr>"), !0 === f.repeatitems) $(f.cell, this).each(function(a) {
                  ...
                  if (a)
                    for (e = 0; e < a.length; e++) k(h, $.jgrid.getXmlData(this, a[e]) || "&#160;", e)
                }
                $(g).append(h)
              }));
              ...
              if ($(m).append(n), a && (h = c.p.jsonReader.subgrid, void 0 !== (e = $.jgrid.getAccessor(a, h.root))))
                for (f = 0; f < e.length; f++) {
                  if (g = e[f], n = $("<tr class='" + j.content + " ui-subtblcell'></tr>"), !0 === h.repeatitems)
                    ...
                    if (o.length)
                      for (l = 0; l < o.length; l++) k(n, $.jgrid.getAccessor(g, o[l]) || "&#160;", l)
                  }
                  $(m).append(n)
                }
    ...
    NumberFormat: function(a, b) {
      if ($.fmatter.isNumber(a) || (a *= 1), $.fmatter.isNumber(a)) {
        ...
        if ($.fmatter.isNumber(b.decimalPlaces)) {
          ...
          if (e = String(Number(Math.round(a + "e" + g) + "e-" + g)), c = e.lastIndexOf("."), g > 0)
    ...
    exportToExcel: function(a) {
      a = $.extend(!0, {
        ...
        if (a.includeLabels && (r(n.header, !0), $("row:last c", i).attr("s", "2")), f.p.grouping) {
          ...
          for (var E = 0, F = n.body.length; E < F; E++) r(n.body[E], !1);
    ...
    exportToHtml: function(a) {
      ...
      return this.each(function() {
        ...
        if (a.includeLabels && (o += "<thead>" + m(i.header, "th", !0) + "</thead>"), o += "<tbody>", f.p.grouping) {
          ...
          for (var h = 0, e = i.body.length; h < e; h++) o += n(i.body[h], "td", !0, 0 === h);
        if (a.includeFooter && f.p.footerrow && (i.footer = $(f).jqGrid("footerData", "get", null, !1), o += n(i.footer, "td", !1)), o += "</tbody>", o += "</table>", a.returnAsString) b = o;
        else {
          var q = window.open("", "");
          q.document.close();
