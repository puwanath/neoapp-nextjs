...
<style type="text/css">
  ...
  @media only screen and (max-width: 480px){
    ...
    #gbox_jqGridlist { height: calc(100% - 0px); }
    #gview_jqGridlist { height: 100%; }
    #gview_jqGridlist .ui-jqgrid-bdiv { height: calc( 100% - 35px ) !important; }
  }
  ...
  $(document).ready(function () {
      ...
      $("#jqGridlist").jqGrid({
        ...
        colModel: [
          ...
          },
          {
              ...
              name: 'member_lastlogin',
              width: 150,
						  editable: false,
          },
          {
				      label: 'รูปแบบการสมัคร',
              name: 'member_signup_status',
              width: 130,
						  editable: false,
          },
          {
    ...
    function editFunc(id,name){
      if ( 'undefined' != typeof id) {
        window.location.href = "<?=$url."/".$get_part0."/edit/";?>"+id;
    ...
    function isFuncStatusBan(status,id){
      if ('undefined'!= typeof id) {
        ...
        $.ajax({
           ...
           async: false,
           url: "<?=$url.'/'.$get_part0;?>",
           data: {select: 'isstatusban',id:id,status:status},
           dataType: "json",
           success: function(data) {
             $("#jqGridlist").jqGrid().trigger("reloadGrid");
           }
