  ...
  $(document).ready(function () {
    ...
    $("#jqGridlist").jqGrid({
      ...
      colModel: [
  			...
  			{ label: 'สถานะสินค้า TH', name: 'prodstatus_name_th', width: 200, editable: true,
  				editrules : { required: false} },
  			{ label: 'สถานะสินค้า EN', name: 'prodstatus_name_en', width: 200, editable: true,
  				editrules : { required: false} },
  		],
			sortname: 'prodstatus_id',
			sortorder : 'asc',
			loadonce: false,
			viewrecords: true,
  		shrinkToFit: false,
