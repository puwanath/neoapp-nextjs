                ...
                <div class="row no-gutters">
                  <div class="col-md-12 mg-t--1 mg-md-t-0">
                    <div class="form-group bd-t-0-force bd-l-0-force bd-r-0-force">
                      <label class="form-control-label">ฝ่าย/แผนก (TH): <span class="tx-danger">*</span></label>
                      <input class="form-control" type="text" name="dep_name_th" id="dep_name_th" value="" placeholder="...">
                      <span id="dep_name_th_msg" class="text-danger"></span>
                    </div>
                  </div>
                  <div class="col-md-12 mg-t--1 mg-md-t-0">
                    <div class="form-group bd-t-0-force bd-l-0-force bd-r-0-force">
                      <label class="form-control-label">ฝ่าย/แผนก (EN): <span class="tx-danger">*</span></label>
                      <input class="form-control" type="text" name="dep_name_en" id="dep_name_en" value="" placeholder="...">
                      <span id="dep_name_en_msg" class="text-danger"></span>
                    </div>
                  </div>
    ...
    $.jgrid.defaults.styleUI = 'Bootstrap4';
      ...
      $(".btnsave").on('click',function(e){
        e.preventDefault();
				...
				if($("#dep_name_th").val()==""){
					$('#dep_name_th_msg').text('กรุณากรอกช่องนี้ด้วยครับ');
				}else{
          $('#dep_name_th_msg').text('');
        }
				if($("#dep_name_en").val()==""){
					$('#dep_name_en_msg').text('กรุณากรอกช่องนี้ด้วยครับ');
				}else{
          $('#dep_name_en_msg').text('');
        }

				if($("#dep_name_th").val()!='' && $("#dep_name_en").val()!=''){
					$("#formdata").submit();
				}else{
					return false;
				}
