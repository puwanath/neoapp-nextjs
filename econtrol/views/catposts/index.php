				 ...
				 <div class="row">
					 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						 <div class="form-group">
 							<label for="cat_name_th">หมวดหมู่ (TH)</label>
 							<input type="text" class="form-control" name="cat_name_th" id="cat_name_th" placeholder="หมวดหมู่ (TH)..." request>
 							<span style="color:red;" id="err_cat_name_th"></span>
 						</div>

 						<div class="form-group">
 							<label for="cat_name_en">หมวดหมู่ (EN)</label>
 							<input type="text" class="form-control" name="cat_name_en" id="cat_name_en" placeholder="หมวดหมู่ (EN)..." request>
 							<span style="color:red;" id="err_cat_name_en"></span>
 						</div>
    ...
    $("#cat_name_en").keyup(function(){
      ...
      $("#slug").val(slug);
		...
		$("#btnsubmit").on('click',function(e){
			...
			if($("#cat_name_th").val()==''){
				$("#cat_name_th").css('border','1px solid red');
				$("#err_cat_name_th").text('กรุณากรอก ชื่อหมวดหมู่ ไทย ด้วยครับ!');
			}

			if($("#cat_name_en").val()==''){
				$("#cat_name_en").css('border','1px solid red');
				$("#err_cat_name_en").text('กรุณากรอก ชื่อหมวดหมู่ อังกฤษ ด้วยครับ!');
			}
      ...
      if($("#slug").val()==''){
        ...
        $("#err_slug").text('กรุณากรอกช่องนี้ ด้วยครับ!');
			...
			if($("#cat_name_th").val()!='' || $("#cat_name_en").val()!='' || $("#slug").val()!=''){
				$("#action-form").submit();
			}else{
				return false;
			}
