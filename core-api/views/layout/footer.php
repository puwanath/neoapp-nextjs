...
<footer class="c-layout-footer c-layout-footer-6 c-bg-grey-1">
			...
			<!-- <div class="c-body">
				<div class="row">
					...
					<div class="col-md-5 col-sm-6 col-xs-12">
						...
						<div class="c-twitter">
							<a class="twitter-timeline" href="https://twitter.com/themehats" data-tweet-limit="2" data-chrome="noheader nofooter noscrollbar noborders transparent">
	...
	<div class="c-postfooter bg-sky">
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-sm-12 c-col text-center">
					<p>
						<a href=""><?=$word->wordvar('Home');?></a> |
						<a href=""><?=$word->wordvar('About us');?></a> |
						<a href=""><?=$word->wordvar('Products');?></a> |
						<a href=""><?=$word->wordvar('Knowledge');?></a> |
						<a href=""><?=$word->wordvar('News');?></a> |
						<a href=""><?=$word->wordvar('Suppliers');?></a> |
						<a href=""><?=$word->wordvar('Contact us');?></a> |
						<a href=""><?=$word->wordvar('Privacy and Policy');?></a> |
						<a href=""><?=$word->wordvar('Terms and Condition');?></a>
					</p>
					<p class="c-copyright c-font-grey"><?=date('Y');?> &copy; <?=getcomp('companyname');?>
